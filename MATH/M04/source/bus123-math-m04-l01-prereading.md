...
kind: "Pre-Reading"
status: "published"
output: "MATH/M04/bus123-math-m04-l01-prereading.md"
---
...
<!--
  ...
  • To push to the public GitHub repo, place this file at:
    MATH/M04/bus123-math-m04-l01-prereading.md
...
```
Excel pattern:
  Target Revenue  = =ProducedUnits * CostPerUnit * (1 + MarkupRate)
  Required Price  = =TargetRevenue / SellableUnits
```
...
```
Excel pattern:
  =ROUNDUP(FixedCost / (TicketPrice - VariableCost), 0)
```
...
2. A $50 ticket is marked down 20%. What is the new price?
